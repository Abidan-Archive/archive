        ...
        <div class="flex flex-1 justify-between sm:hidden">
            ...
            {:else}
                <a
                    use:inertia
                    href={prev_page_url}
                    class="relative inline-flex items-center rounded-md border bg-base-700 px-4 py-2 text-sm font-medium leading-5 text-gray-300 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-500 focus:border-blue-300 focus:outline-none focus:ring active:bg-gray-100 active:text-gray-100">
                    &laquo; Previous></a>
            {/if}
            ...
            {#if current_page < last_page}
                <a
                    use:inertia
                    href={next_page_url}
                    class="relative ml-3 inline-flex items-center rounded-md border bg-base-700 px-4 py-2 text-sm font-medium leading-5 text-gray-300 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-500 focus:border-blue-300 focus:outline-none focus:ring active:bg-gray-100 active:text-gray-300"
                    >Next &raquo;</a>
            {:else}
                <span
                ...
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    ...
                    {:else}
                        <a
                            ...
                            rel="prev"
                            aria-label="Previous"
                            class="relative -ml-px inline-flex items-center rounded-l-md border bg-base-700 px-2 py-2 text-sm font-medium leading-5 text-gray-200 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-400 focus:z-10 focus:border-blue-300 focus:outline-none focus:ring active:bg-gray-500 active:text-gray-100">
                            <Previous />
                        </a>
                    {/if}
                    ...
                    {#each links.slice(1, links.length - 1) as link}
                        ...
                        {:else}
                            <a
                                ...
                                class="relative -ml-px inline-flex items-center border bg-base-700 px-4 py-2 text-sm font-medium leading-5 text-gray-300 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-500 focus:z-10 focus:border-blue-300 focus:outline-none focus:ring active:bg-gray-100 active:text-gray-300">
                                {link.label}
                            </a>
                        {/if}
                    {/each}
                    ...
                    {#if current_page < last_page}
                        <a
                            ...
                            rel="next"
                            aria-label="Next"
                            class="relative -ml-px inline-flex items-center rounded-r-md border bg-base-700 px-2 py-2 text-sm font-medium leading-5 text-gray-200 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-400 focus:z-10 focus:border-blue-300 focus:outline-none focus:ring active:bg-gray-500 active:text-gray-100">
                            <Next />
                        </a>
                    {:else}
